# ============================================================
#  agent.py — PRODUCTION STABLE LiveKit Translator
# ============================================================
...
# ============================================================
# Voice API CLIENT (STABLE STREAM VERSION)
# ============================================================
...
class SpeakerPipeline:
    ...
    def on_audio_frame(self, frame: rtc.AudioFrame):
        ...
        # time + size based flush = stable streaming
...
class Manager:
    ...
    def listeners(self, lang, exclude):
        return [i for i, l in self.listeners.items() if l == lang and i != exclude]
    ...
    def reconcile_all(self):
        ...
        for i, pipe in self.pipelines.items():
            needed = {lang for x, lang in self.listeners.items() if x != i}
    ...
    def on_join(self, p):
        ...
        asyncio.create_task(pipe.handle_track)
